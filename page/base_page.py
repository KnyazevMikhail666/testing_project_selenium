...
class BasePage:
    ...
    def user_generation(self):
        user = (str(time.time()) + "@fakemail.org", 'test12345password')
        return user

    def _go_to(self, css_selector: tuple):
        login_link = self.browser.find_element(*css_selector)
        login_link.click()

    def go_to_basket(self):
        self._go_to(BasketPageLocators.BUTTON_BASKET)

    def go_to_login(self):
        self._go_to(MainPageLocators.LOGIN_LINK)
